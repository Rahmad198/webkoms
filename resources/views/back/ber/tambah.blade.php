...
@section('isi')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class="mb-0 mb-2 font-weight-bold" style="color:#000000;">Berita / Tambah Data</h1>
        </div>
        <!-- Content Row -->
            ...
            <div class="modal-body">
                <form action="/berita/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input name="penulis" type="text" class="form-control" id="inputPenulis" placeholder="Penulis" style="color: black">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="inputJudul">Judul</label>
                        <input name="judul" type="text" class="form-control" id="inputJudul" placeholder="Judul" style="color: black">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="inputTulisan">Tulisan</label>
                        <textarea name="tulisan" type="text" class="form-control" id="inputTulisan" rows="3" placeholder="Tulisan" style="color: black"></textarea>
                    </div>
